...
<body>
    <div class="class-0">
        ...
        <div class="container">
            <div class="img-1">
                <img src="images/school.jpg" alt="MIIT Logo">
                <h3>Microsystems International Institute of Technology Inc.</h3>
            </div>
            <form class="class-3" action="login.php" method="post" enctype="multipart/form-data" id="loginForm">
                <h2>Log in</h2>
                <p>New User? <span><a class="class-2" href="signUp.php">Sign Up</a></span></p>
                <div class="class-3.1">
                    <div>
                ...
                <button type="submit" class="login-btn">Login</button><span> <a href="#" class="fpass">Forgot Password</a></span>
            </form>
        </div>
    </div>
